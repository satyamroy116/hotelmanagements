...
# row 2#####
  ...
  self.combo_security_question["values"]=("Select","Your Birth Place","Your Pet Name","Your childhood Name","Your Pornstar Name","Your Sex Position")
  ...
  pswrd=Label(frame, text="Password", font=("times new roman", 15, "bold"), bg="white", fg="black")
  ...
  self.txt_confirm_pass = ttk.Entry(frame, textvariable=self.var_confirmpass, font=("times new roman", 15))
  ...
  checkbtn = Checkbutton(frame,variable=self.var_check, text="I Agree The Terms & Conditions", font=("times new roman", 13),onvalue=1,offvalue=0)
  ...
  btn2 = Button(frame, image=self.photoimage1, borderwidth=0, cursor="hand2" ,font=("times new roman", 20))
