...
# background image
  self.bg = ImageTk.PhotoImage(
      file=r"C:\Users\91787\Desktop\hotel management project\flower-3140492_1280.jpg")
  ...
  # left_lbl.place(x=50, y=200, width=470, relheight=100)
...
#logo
  ...
  # img5 = Image.open(
  #     r"C:\Users\91787\Desktop\project\pexels-rajesh-tp-1624487.jpg")
  # img5 = img5.resize((230, 190), Image.ANTIALIAS)
  # self.photoimg5 = ImageTk.PhotoImage(img5)

  # lblimg3= Label(main_frame, image=self.photoimg4, bd=4, relief=RIDGE)
  # lblimg3.place(x=0, y=420, width=230, height=210)
